...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (btnGirar && disco) {
    ...
    function girarFrame() {
      // rotação bem rápida → cores se misturam e dão a ilusão de branco
      angulo = (angulo + 48) % 360;
      disco.setAttribute('transform', 'rotate(' + angulo + ')');
    ...
    btnGirar.addEventListener('click', function () {
      ...
      if (girando) {
        ...
        angulo = 0;
        disco.setAttribute('transform', 'rotate(0)');
