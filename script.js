...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (btnGirar && disco) {
    ...
    function girarFrame() {
      // gira no centro (como uma roda), bem rápido → cores viram branco
      angulo = (angulo + 36) % 360;
      disco.setAttribute('transform', 'rotate(' + angulo + ' 0 0)');
      animId = requestAnimationFrame(girarFrame);
    }
    ...
    btnGirar.addEventListener('click', function () {
      ...
      if (girando) {
        ...
        angulo = 0;
        disco.setAttribute('transform', 'rotate(0 0 0)');
